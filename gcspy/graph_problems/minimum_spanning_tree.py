...
def directed_minimum_spanning_tree(conic_graph, root, subtour_elimination, binary, tol, **kwargs):
    """
    ...
    # TODO: can these be substituted with the subtour elimination constraints?
